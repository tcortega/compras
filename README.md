...
From `infra`, `docker compose up --build --wait` serves the explorer at http://127.0.0.1:3100 and the API at http://127.0.0.1:5080 against the 2024 warehouse slice (Volta Redonda and Niterói in RJ, Bauru in SP, Caxias do Sul in RS, Joinville in SC).
