...
Compose (`infra/`) seeds the 2024 warehouse of 159 municípios listed in `web/lib/copy.ts` `SLICE_MUNICIPIOS` via Python, then serves this API on http://127.0.0.1:5080.
