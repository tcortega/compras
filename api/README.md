...
Compose (`infra/`) seeds the 2024 warehouse (Volta Redonda, Niterói, Bauru, Caxias do Sul, Joinville, Uberlândia, Londrina, Feira de Santana, Caruaru, Anápolis, Vila Velha, Campina Grande, Caucaia) via Python, then serves this API on http://127.0.0.1:5080.
