...
O recorte publicado agora é Volta Redonda e Niterói (RJ), Bauru (SP), Caxias do Sul (RS), Joinville (SC), Uberlândia (MG), Londrina (PR), Feira de Santana (BA), Caruaru (PE), Anápolis (GO) e Vila Velha (ES), códigos IBGE 3306305, 3303302, 3506003, 4305108, 4209102, 3170206, 4113700, 2910800, 2604106, 5201108 e 3205200, ano 2024, extraído dos arquivos em lote do Compras.gov.br.
