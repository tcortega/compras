...
Vitória, ES, IBGE 3205309, has municipal COMPRA rows only from VITORIA CAMARA MUNICIPAL, with no MUNICIPIO DE VITORIA or PREFEITURA MUNICIPAL DE VITORIA pair.
Cariacica, ES, IBGE 3201308, has MUNICIPIO DE CARIACICA COMPRA rows and no ITEM rows.
No unused ES mid-size municipal executive COMPRA+ITEM pair remains in that 2024 COMPRA file.
Itaquaquecetuba, Praia Grande, São José dos Pinhais, Suzano, Guarujá, Cotia, Parauapebas, Jacareí, Itaboraí, and Maricá are the leftover biggest municipal executive COMPRA+ITEM rows in the 100k-500k band after Vitória stayed Câmara-only.
