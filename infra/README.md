...
The seed runs the existing Python ingest/normalize into Postgres and ClickHouse using the in-repo 2024 fixture: Volta Redonda RJ 3306305, Niterói RJ 3303302, Bauru SP 3506003, Caxias do Sul RS 4305108, Joinville SC 4209102, Uberlândia MG 3170206, and Londrina PR 4113700.
...
A browser on the explorer home must show the published slice with `n`, UF (RJ, SP, RS, SC, MG, PR, or UF mista when mixed), trimestre, and metodologia.
