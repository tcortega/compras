...
def main() -> int:
    ...
    if not isinstance(orgao_cov.get("n"), int) or orgao_cov["n"] < 45:
    ...
    if "Quarenta e cinco municípios" not in home:
    ...
    orgaos_html = get_text(f"{WEB}/orgaos?take=50")
