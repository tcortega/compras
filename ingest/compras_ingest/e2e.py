...
EXTRA_ORGAOS = (
    ...
    ("04508933000145", "1200104", "AC"),
    ("04051207000146", "1200344", "AC"),
    ("04034583000122", "1200401", "AC"),
    ("01674973000179", "1200609", "AC"),
    ("12333753000106", "2701704", "AL"),
    ("12250908000132", "2702504", "AL"),
    ("12200168000120", "2707701", "AL"),
    ("12332946000134", "2709301", "AL"),
    ("04530713000118", "1300201", "AM"),
    ("04263331000175", "1301308", "AM"),
    ("04477634000190", "1304005", "AM"),
    ("05995766000177", "1600303", "AP"),
    ("14222012000175", "2908101", "BA"),
    ("13846753000164", "2912707", "BA"),
    ("13743281000114", "2927309", "BA"),
    ("13696257000171", "2929602", "BA"),
    ("07911696000157", "2301000", "CE"),
    ("07954605000160", "2304400", "CE"),
    ("12359535000132", "2304954", "CE"),
    ("23555196000186", "2305233", "CE"),
    ("27165653000187", "3203106", "ES"),
    ("27165687000171", "3203700", "ES"),
    ("27165703000126", "3204302", "ES"),
    ("01612865000171", "3204955", "ES"),
    ("36862621000121", "5205497", "GO"),
    ("01303221000100", "5208509", "GO"),
    ("02451938000153", "5210406", "GO"),
    ("00097857000171", "5219753", "GO"),
    ("01597627000134", "2104552", "MA"),
    ("12511093000106", "2110039", "MA"),
    ("01612333000134", "2110658", "MA"),
    ("06307102000130", "2111300", "MA"),
    ("18715383000140", "3106200", "MG"),
    ("18659334000137", "3111200", "MG"),
    ("17888082000155", "3120201", "MG"),
    ("18307835000154", "3131901", "MG"),
    ("03576220000156", "5001904", "MS"),
    ("03442597000112", "5005400", "MS"),
    ("03214145000183", "5102504", "MT"),
    ("04178518000170", "5107743", "MT"),
    ("01614112000103", "1501451", "PA"),
    ("05149166000198", "1506203", "PA"),
    ("05193115000163", "1507201", "PA"),
    ("23060866000193", "1507979", "PA"),
    ("08778318000100", "2500601", "PB"),
    ("08923971000115", "2503704", "PB"),
    ("09073628000191", "2509701", "PB"),
    ("09069709000118", "2513901", "PB"),
    ("10260222000105", "2601706", "PE"),
    ("10091510000175", "2601904", "PE"),
    ("11358140000152", "2612802", "PE"),
    ("11361201000130", "2615201", "PE"),
    ("01612573000139", "2202075", "PI"),
    ("06553713000169", "2204204", "PI"),
    ("01612805000159", "2210623", "PI"),
    ("06985832000190", "2211209", "PI"),
    ("75732057000184", "4103701", "PR"),
    ("76205640000108", "4107207", "PR"),
    ("77816510000166", "4108403", "PR"),
    ("76995323000124", "4115309", "PR"),
    ("76995448000154", "4118501", "PR"),
    ("77003424000134", "4120606", "PR"),
    ("76205673000140", "4121406", "PR"),
    ("76205699000198", "4122800", "PR"),
    ("76170240000104", "4127106", "PR"),
    ("78279973000107", "4127965", "PR"),
    ("78101821000101", "4128559", "PR"),
    ("29172467000109", "3300100", "RJ"),
    ("31846892000170", "3302254", "RJ"),
    ("42498733000148", "3304557", "RJ"),
    ("28909604000174", "3305208", "RJ"),
    ("08349102000129", "2402303", "RN"),
    ("08109126000100", "2403103", "RN"),
    ("08241747000496", "2408102", "RN"),
    ("01266058000144", "1100452", "RO"),
    ("04279238000159", "1100114", "RO"),
    ("05903125000145", "1100205", "RO"),
    ("05943030000155", "1400100", "RR"),
    ("01612682000156", "1400175", "RR"),
    ("04653408000113", "1400209", "RR"),
    ("04056230000123", "1400605", "RR"),
    ("87990800000185", "4303103", "RS"),
    ("87613154000137", "4305900", "RS"),
    ("87613022000105", "4318903", "RS"),
    ("87572079000103", "4319802", "RS"),
    ("83024240000153", "4208005", "SC"),
    ("83021865000161", "4214201", "SC"),
    ("83102491000109", "4217402", "SC"),
    ("83009860000113", "4219507", "SC"),
    ("46634101000115", "3507506", "SP"),
    ("44435121000131", "3508108", "SP"),
    ("51885242000140", "3509502", "SP"),
    ("46319000000150", "3518800", "SP"),
    ("45332095000189", "3530805", "SP"),
    ("46189718000179", "3536703", "SP"),
    ("56024581000156", "3543402", "SP"),
    ("45368545000193", "3547601", "SP"),
    ("59851600000106", "3549508", "SP"),
    ("45787678000102", "3556206", "SP"),
    ("01795483000120", "1705508", "TO"),
)
...
def _assert_pncp_gaps_job(settings: Settings) -> None:
    ...
    if len(targets) != len(SLICE_IBGE_CODES):
        raise SystemExit(f"PNCP gaps live targets {len(targets)} != {len(SLICE_IBGE_CODES)}")
    ibges = {ibge for ibge, _ in targets}
    if ibges != set(SLICE_IBGE_CODES):
        raise SystemExit("PNCP gaps live targets drifted from SLICE_IBGE_CODES")
