...
export async function assertCoverageAndBan(page: Page) {
  ...
  await expect(
    page.getByText(/UF RJ|UF SP|UF RS|UF SC|UF MG|UF PR|UF BA|UF PE|UF GO|UF ES|UF PB|UF CE|UF MA|UF AL|UF MS|UF PA|UF MT|UF RO|UF RN|UF AC|UF AP|UF RR|UF AM|UF PI|UF TO|UF mista|filtro sem registros/).first(),
  ).toBeVisible()
