...
test('home cards usam o n da coleção, não o n de itens', async ({ page }) => {
  ...
  if (!againstCompose) {
    await expect(orgaos.getByRole('strong')).toHaveText('32')
    await expect(itens.getByRole('strong')).toHaveText('56')
  }
